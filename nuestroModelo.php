    ...
    <div class="about">
        <div class="wrapper">
            ...
            <p style="font-size: 22px;">
                Utilizar HTML, CSS y JavaScript en nuestro proyecto no solo optimiza la funcionalidad y el
                diseño, sino que también potencia la accesibilidad y la experiencia del usuario.
                <br>
                Estas tres tecnologías son lenguajes bien documentados y ampliamente utilizados, lo que significa que
                hay
                una gran cantidad de recursos, bibliotecas y frameworks disponibles. Esto acelera el proceso de
                desarrollo y
                facilita la implementación de funcionalidades complejas sin reinventar la rueda.
...
<style>
    * {
    ...
    .about {
        ...
        min-height: 100vh;
        background: linear-gradient(45deg, darkgoldenrod, darkslategray, darkturquoise, darkcyan, blue);

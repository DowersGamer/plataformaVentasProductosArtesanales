    ...
    <div class="about">
        <div class="wrapper">
            ...
            <p style="font-size: 22px;">
                En CoopArtesanos, somos revendedores; al actuar como revendedores, proporcionamos a los artesanos una
                plataforma para mostrar su trabajo. Muchos de ellos carecen de los recursos y conocimientos necesarios
                para comercializar sus creaciones. Nuestra misión es dar visibilidad a su arte, ayudando a que sus
                historias y tradiciones sean compartidas y apreciadas.
            </p>
        </div>
    </div>
</body>
<style>
    * {
    ...
    .about {
        ...
        min-height: 100vh;
        background: linear-gradient(45deg, blue, aqua, black, purple);
